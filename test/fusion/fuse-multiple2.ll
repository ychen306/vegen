; RUN: %test-loop-fusion %s -fusion-group=for.body,for.body16,for.body5,for.body27 | FileCheck %s
; RUN: %test-loop-fusion %s -fusion-group=for.body,for.body16,for.body5,for.body27 -do-fusion | FileCheck %s --check-prefixes=DO_FUSION
...
; CHECK: Fusing for.body and for.body5 is safe
; CHECK: Fusing for.body and for.body27 is safe
; CHECK: Fusing for.body16 and for.body5 is safe
; CHECK: Fusing for.body16 and for.body27 is safe
