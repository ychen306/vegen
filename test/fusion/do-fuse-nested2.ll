...
; DO_FUSION-NEXT:   %6 = load i32, i32* %arrayidx12, align 4
; DO_FUSION-NEXT:   %mul = mul nsw i32 %6, 42
...
; DO_FUSION-NEXT:   %9 = load i32, i32* %arrayidx39, align 4
; DO_FUSION-NEXT:   %mul40 = mul nsw i32 %9, 42
