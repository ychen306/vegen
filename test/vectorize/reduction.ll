; RUN: %opt -gslp %s -o %t && %check-function  2 'int reduce(int, int*, int*)' 'reduce(100, %%s, %%s)' %t %s
; RUN: %opt -gslp %s | opt -O1 -S | FileCheck %s
...
define dso_local i32 @reduce(i32 %n, i32* nocapture readonly %a, i32* nocapture readonly %b) local_unnamed_addr #0 {
entry:
...
for.body:                                         ; preds = %for.body, %for.body.preheader
  ...
  %sum.010 = phi i32 [ 0, %for.body.preheader ], [ %add, %for.body ]
